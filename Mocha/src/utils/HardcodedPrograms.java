...
public class HardcodedPrograms {
    ...
    public HardcodedPrograms() {
        ...
        Statement ex4 = new CompoundStatement(new DeclarationStatement("varf", new model.type.StringType()), new CompoundStatement(new AssignStatement("varf", new ValueExpression(new model.value.StringValue("test.in"))), new CompoundStatement(new OpenReadFileStatement(new VariableExpression("varf")), new CompoundStatement(new DeclarationStatement("varc", new IntType()), new CompoundStatement(new ReadFileStatement(new VariableExpression("varf"), "varc"), new CompoundStatement(new PrintStatement(new VariableExpression("varc")), new CompoundStatement(new ReadFileStatement(new VariableExpression("varf"), "varc"), new PrintStatement(new VariableExpression("varc")))))))));
        statements.add(ex1);
        statements.add(ex2);
        statements.add(ex3);
        statements.add(ex4);
